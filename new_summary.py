...
parser.add_argument('-p', '--path', type=str, default= "/home/vinsent/Downloads/Torrient_fraction/data", help="path to h5 result file")
...
def main():
    ...
    print(args.idx)
    print(h5_res.keys())
    key = h5_res.keys()['video_1']
    # key = h5_res.keys()['video_' + str(args.idx + 1)]
    
    # summary = h5_res[key]['machine_summary'][...]
    h5_res.close()
    frm2video(args.path, frame_num_binary, vid_writer)
    vid_writer.release()

    # frm_dir = "/home/vinsent/Downloads/Torrient_fraction/data"
    # frm2video(frm_dir,frame_num_binary, vid_writer)
